 ...
 */
public class GrantQueryUI extends AppCompatActivity {
    @Override
    ...
    public void viewRepayment(View view) {
        ...
        startActivity(new Intent(GrantQueryUI.this, RepaymentQueryUI.class));
    }
    public void viewGrant(View view) {
        // Do something in response to button
        startActivity(new Intent(GrantQueryUI.this, GrantQueryUI.class));
    }

    public void viewFlats(View view) {
        // Do something in response to button
        startActivity(new Intent(GrantQueryUI.this, ViewFlatQueryUI.class));
    }
}
